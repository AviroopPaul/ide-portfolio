...
app.post('/api/chat', async (req, res) => {
  ...
  try {
    ...
    const systemPrompt = `
      ...
      - Resume Link: ${profile.resume ?? 'https://drive.google.com/file/d/1OnxrfVIUY-qNO3RPxEjoWrRXcExte4wT/view?usp=drive_link'}
    ...
    const completion = await groq.chat.completions.create({
      ...
      model: 'openai/gpt-oss-120b', // Reliable high-perf OSS model on Groq
    });
